...
import { DangerButton, SecondaryButton } from '@/Components/FormElements';
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-6">
                    ...
                    <div className="mt-6">
                        ...
                        <Input id="password" type="password" name="password" ref={passwordInput} value={data.password} onChange={e => setData('password', e.target.value)} placeholder="Password" />
